...
import { RedisClusterOptions } from '@node-redis/client/dist/lib/cluster';
import { RedisCommandArgument, RedisModules, RedisScripts } from '@node-redis/client/dist/lib/commands';
