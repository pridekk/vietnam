...
const _LIST = require("@node-redis/search/dist/commands/_LIST");
const ALTER = require("@node-redis/search/dist/commands/ALTER");
const AGGREGATE = require("@node-redis/search/dist/commands/AGGREGATE");
const ALIASADD = require("@node-redis/search/dist/commands/ALIASADD");
const ALIASDEL = require("@node-redis/search/dist/commands/ALIASDEL");
const ALIASUPDATE = require("@node-redis/search/dist/commands/ALIASUPDATE");
const CONFIG_GET = require("@node-redis/search/dist/commands/CONFIG_GET");
const CONFIG_SET = require("@node-redis/search/dist/commands/CONFIG_SET");
const CREATE = require("@node-redis/search/dist/commands/CREATE");
const DICTADD = require("@node-redis/search/dist/commands/DICTADD");
const DICTDEL = require("@node-redis/search/dist/commands/DICTDEL");
const DICTDUMP = require("@node-redis/search/dist/commands/DICTDUMP");
const DROPINDEX = require("@node-redis/search/dist/commands/DROPINDEX");
const EXPLAIN = require("@node-redis/search/dist/commands/EXPLAIN");
const EXPLAINCLI = require("@node-redis/search/dist/commands/EXPLAINCLI");
const INFO = require("@node-redis/search/dist/commands/INFO");
const PROFILESEARCH = require("@node-redis/search/dist/commands/PROFILE_SEARCH");
const PROFILEAGGREGATE = require("@node-redis/search/dist/commands/PROFILE_AGGREGATE");
const SEARCH = require("@node-redis/search/dist/commands/SEARCH");
const SPELLCHECK = require("@node-redis/search/dist/commands/SPELLCHECK");
const SUGADD = require("@node-redis/search/dist/commands/SUGADD");
const SUGDEL = require("@node-redis/search/dist/commands/SUGDEL");
const SUGGET_WITHPAYLOADS = require("@node-redis/search/dist/commands/SUGGET_WITHPAYLOADS");
const SUGGET_WITHSCORES_WITHPAYLOADS = require("@node-redis/search/dist/commands/SUGGET_WITHSCORES_WITHPAYLOADS");
const SUGGET_WITHSCORES = require("@node-redis/search/dist/commands/SUGGET_WITHSCORES");
const SUGGET = require("@node-redis/search/dist/commands/SUGGET");
const SUGLEN = require("@node-redis/search/dist/commands/SUGLEN");
const SYNDUMP = require("@node-redis/search/dist/commands/SYNDUMP");
const SYNUPDATE = require("@node-redis/search/dist/commands/SYNUPDATE");
const TAGVALS = require("@node-redis/search/dist/commands/TAGVALS");
