import * as ADD from '@node-redis/time-series/dist/commands/ADD';
import * as ALTER from '@node-redis/time-series/dist/commands/ALTER';
import * as CREATE from '@node-redis/time-series/dist/commands/CREATE';
import * as CREATERULE from '@node-redis/time-series/dist/commands/CREATERULE';
import * as DECRBY from '@node-redis/time-series/dist/commands/DECRBY';
import * as DEL from '@node-redis/time-series/dist/commands/DEL';
import * as DELETERULE from '@node-redis/time-series/dist/commands/DELETERULE';
import * as GET from '@node-redis/time-series/dist/commands/GET';
import * as INCRBY from '@node-redis/time-series/dist/commands/INCRBY';
import * as INFO_DEBUG from '@node-redis/time-series/dist/commands/INFO_DEBUG';
import * as INFO from '@node-redis/time-series/dist/commands/INFO';
import * as MADD from '@node-redis/time-series/dist/commands/MADD';
import * as MGET from '@node-redis/time-series/dist/commands/MGET';
import * as MGET_WITHLABELS from '@node-redis/time-series/dist/commands/MGET_WITHLABELS';
import * as QUERYINDEX from '@node-redis/time-series/dist/commands/QUERYINDEX';
import * as RANGE from '@node-redis/time-series/dist/commands/RANGE';
import * as REVRANGE from '@node-redis/time-series/dist/commands/REVRANGE';
import * as MRANGE from '@node-redis/time-series/dist/commands/MRANGE';
import * as MRANGE_WITHLABELS from '@node-redis/time-series/dist/commands/MRANGE_WITHLABELS';
import * as MREVRANGE from '@node-redis/time-series/dist/commands/MREVRANGE';
import * as MREVRANGE_WITHLABELS from '@node-redis/time-series/dist/commands/MREVRANGE_WITHLABELS';
